...
(.deb) for [lazygit](https://github.com/jesseduffield/lazygit/) hosted at [deb.griffo.io](https://deb.griffo.io)

<p align="center">
⭐⭐⭐ Love using lazygit on Debian? Show your support by starring this repo or [subscribing](https://buy.stripe.com/aFa28q8hr0lRdlm4a2enS01) — from 1 October 2026, apt access requires a yearly subscription. ⭐⭐⭐
</p>
...
📖 **Step-by-step install guide:** [Debian](https://deb.griffo.io/install-latest-lazygit-in-debian.html) · [Ubuntu](https://deb.griffo.io/install-latest-lazygit-in-ubuntu.html)
...
> the .deb from the [Releases](https://github.com/dariogriffo/lazygit-debian/releases) page
